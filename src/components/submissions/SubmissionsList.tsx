          ...
          <Collapsible open={showAdvancedFilters} onOpenChange={setShowAdvancedFilters}>
            <CollapsibleContent className="space-y-6 pt-4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={value} className="flex items-center space-x-3">
                        ...
                        />
                        <Label htmlFor={`status-${value}`} className="flex items-center gap-2 text-sm cursor-pointer min-w-0">
                          {icon}
                ...
                {/* Approval Type Filter */}
                <div className="space-y-4">
                  <Label className="text-sm font-semibold text-foreground">Approval Type</Label>
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={value} className="flex items-center space-x-3">
                        <Checkbox
                          ...
                          className="flex-shrink-0"
                        />
                        <Label htmlFor={`approval-${value}`} className="flex items-center gap-2 text-sm cursor-pointer min-w-0">
                          {icon}
                          <span className="whitespace-nowrap">{label}</span>
                        </Label>
                      </div>
                    ...
                    {[
                      ...
                      <div key={value} className="flex items-center space-x-3">
                        <Checkbox
                          ...
                          className="flex-shrink-0"
                        />
                        <Label htmlFor={`risk-${value}`} className="flex items-center gap-2 text-sm cursor-pointer min-w-0">
                    ...
                    {[
                      ...
                      <div key={value} className="flex items-center space-x-3">
                        <Checkbox
                          ...
                          className="flex-shrink-0"
                        />
                        <Label htmlFor={`type-${value}`} className="flex items-center gap-2 text-sm cursor-pointer min-w-0">
                          {icon}
                          <span className="whitespace-nowrap">{label}</span>
                        </Label>
                      </div>
              ...
              <div className="flex justify-between items-center py-2">
                ...
                <Button variant="outline" size="sm" onClick={clearAllFilters} className="h-9 px-4">
